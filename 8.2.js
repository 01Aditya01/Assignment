...
// by any number. To do this we increment i by 6 because all prime numbers are in the form of either 6n+1 or 6n-1.
...
// to find the next prime number after x, we run a loop and check subsequent odd numbers after x that if they are prime or not.
if (x % 2 == 0) y = x + 1;
else y = x + 2;
